 ...
 * 		timestamp
 * 
 * 		java.sql.Date.valueOf("yyyy-MM-dd"); "2020-03-25";
 * 
 * 	分页查询
 * 
 * 	事务管理
...
public class DBHelper {
	 ...
	 * @return
	 */
	public Connection openConnection() {//数据库名
		//?useUnicode=true&characterEncoding=UTF-8
		String url = "jdbc:mysql://127.0.0.1/a?useUnicode=true&characterEncoding=UTF-8" ; // 数据库的地址 jdbc:oracle:thin:@localhost:1521:orcl
...
//					
	...
	public List<Map<String, Object>> queryPage(String sql, int pageNumber, int pageSize, Object... params) {
		...
		// number = 3, size = 5; => begin = 11, end = 15
